...
df<- read_dta("C:/Users/solis/Dropbox/WZB/KCCA_C19_dashboard/data/baseline_r1r2_0801.dta")
...
villageSHP <- read_sf("C:/Users/solis/Dropbox/WZB/KCCA_C19_dashboard/maps/Villages-20190522/KC-villages-20190522.shp")
...
parish <- read_sf("C:/Users/solis/Dropbox/WZB/KCCA_C19_dashboard/maps/Parishes/Parishes.shp") %>% dplyr::rename(parish = UBOS_PN_13) %>% 
...
districtSHP <- read_sf("C:/Users/solis/Dropbox/WZB/KCCA_C19_dashboard/maps/uga_admbnd_2020_shp/uga_admbnda_adm4_2020.shp")%>% st_transform(crs = "+proj=longlat +datum=WGS84 +init=epsg:4326 +no_defs")
...
p_fol_gov <- ggplot(varsDF) +
  ...
  labs(x = "Longitude",
       y = "Latitude",
       title = "How many out of 10 do you think follow gov't policies?") +
  theme_clean() +  
