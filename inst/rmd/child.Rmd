...
```{r, eval=(my_subset$family[[1]]=="Knowledge and assessment"), echo = FALSE, fig.height = 8, fig.width=9.5, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Food security"), echo = FALSE, fig.height = 8, fig.width=6, message = FALSE, warning = FALSE, results = 'hide'}
