...
```{r, eval=(my_subset$family[[1]]=="Health-seeking"), echo = FALSE, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Beliefs about Covid"), echo = FALSE, message = FALSE, warning = FALSE, results = 'hide'}
