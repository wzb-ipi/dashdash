...
```{r, eval=(my_subset$family[[1]]=="Elections_"), echo = FALSE, fig.height = 6, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
nrow <- 2
  ...
  subplots <- lapply(1:length(vars), function(x){
    ...
    question_label <- dashdash:::split_every(var_labs[names(var_labs) == vars[x]], 6, pattern = " ")
...
```{r, eval=(my_subset$family[[1]]=="Vaccine acceptability_"), echo = FALSE, fig.height = 8, fig.width=12, message = FALSE, warning = FALSE, results = 'hide'}

together_plot_m <- function(df, my_vars){
  together_vars <- my_vars
  prefix <- together_vars$together[[1]]
  common_question <- dashdash:::split_every(together_vars$title[[1]], 6, pattern = " ")
...
bars_together_ <- function(df, my_vars, nrow=NULL){
  ...
  if("together" %in% colnames(my_vars))
  {
    ...
    for (common in unique(together_vars$together)) {
      ...
      t <- together_plot_m(my_data, n_common)
...
bars_together_(my_data, my_subset, nrow=2)

```

```{r, eval=(my_subset$family[[1]]=="Government performance_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Trust_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="COVID-19 Symptoms_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Social perception_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Policy evaluation_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Preventive measures_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Health"), echo = FALSE, fig.height = 8, fig.width=8, message = FALSE, warning = FALSE, results = 'hide'}

all_bar_plot(my_data, my_subset, nrow=3)

```

```{r, eval=(my_subset$family[[1]]=="Elections 2021"), echo = FALSE, fig.height = 8, fig.width=12, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Employment"), echo = FALSE, fig.height = 13, fig.width=10, message = FALSE, warning = FALSE, results = 'hide'}
...
p_twork <- ggplot(df_twork, aes(x=Hours,y=perc)) +
  ...
  ggtitle(paste0("Over the past 7 days, how much time \n have you worked compared to a typical week before?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_earnings <- ggplot(df_earnings, aes(x=Earnings,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold")) +
ggtitle(paste0("Over the past 7 days, how much are your \n earnings compared to a typical week before?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_effwage <- ggplot(df_effwage, aes(x=levels,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold")) +
ggtitle(paste0("How concerned are you about the possible \n effects of Coronavirus on your household income?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_exp30 <- ggplot(data = df_exp30,aes(x=question,y=Perc.)) + 
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold")) +
ggtitle(paste0("In the last 30 days, have you experienced...?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_ask_help <- ggplot(data=ask_help,aes(x=Level, y=Perc.)) + 
  ...
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Days",title=paste0('In the past week, how many days have you asked for help?', " ", "(n=", n, ")")) +
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_rec_help <- ggplot(data=rec_help,aes(x=Level, y=Perc.)) + 
  ...
  coord_flip() + ylim(0, 100) +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Days",title=paste0('In the past week, how many days have you received help?', " ", "(n=", n, ")")) +
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_eat_few <- ggplot(data=eat_few,aes(x=Level, y=Perc.)) + 
  ...
  coord_flip() + ylim(0, 100) +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Days",title=paste0('In the past week, how many days have you eaten fewer?', " ", "(n=", n, ")")) +
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_no_eat <- ggplot(data=no_eat,aes(x=Level, y=Perc.)) + 
  ...
  coord_flip() + ylim(0, 100) +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Days",title=paste0('In the past week, how many days have you gone without eating', " ", "(n=", n, ")")) +
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_mob <- ggplot(df_mob, aes(x=Difficulty,y=perc)) +
  ...
  labs(title = paste0("Have you experienced difficulties in buying food?", " ", "(n=", n, ")"), x= NULL, y= "percent") +
  ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_mobdif <- ggplot(data = df_mobdif,aes(x=question,y=Perc.)) + 
  ...
  labs(title = paste0("Reasons of difficulty in buying food", " ", "(n=", n, ")"), x= NULL, y= "percent") +
  ylim(0,100)+
  theme(axis.text.x = element_text(colour="black",size=11), axis.text.y = element_text(colour="black",size=11))+ theme_minimal()
...
p_sympt = ggplot(data = df_sympt,aes(x=option,y=Perc.)) + 
  ...
  coord_flip()  +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Option",title=paste0("Respondents' Mention of Symptoms", " ", "(n=", n, ")")) + ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
p_sympt
```
...
p_ownbsn <- ggplot(df_ownbs, aes(x=`Own Business`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold"))+
  ggtitle(paste0("Did you run your own business \n at the time government closed schools in March?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_stillown <- ggplot(df_stillown, aes(x=`Still Operational`,y=perc)) +
  geom_bar(stat="identity") +
  geom_text(aes(label=perc),size=3, vjust = -0.2) +
  ylab("% of Respondents") + xlab("Business still operational?") + ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold"))+
  ggtitle(paste0("Is the business currently operational?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_stbsn <- ggplot(df_stbs, aes(x=`Start Business`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold"))+
  ggtitle(paste0("Have you started a new business \n since the governemnt shut down since March?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_bsnpol <- ggplot(bsnpol, aes(x=Support_Policy,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"), 
        plot.title = element_text(size = 10, face = "bold"))+
  ggtitle(paste0("What would be the most needed policy \n to support your business over the COVID-19 crisis?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_cure = ggplot(data = df_cure,aes(x=option,y=Perc.)) + 
  ...
  coord_flip() +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Option",title=paste0("Respondents' Mention of Cures", " ", "(n=", n, ")")) +
  ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
```{r, eval=(my_subset$family[[1]]=="Risk perception"), echo = FALSE, message = FALSE, warning = FALSE, results = 'hide', fig.height = 9, fig.width = 9}
...
p_prot <- ggplot(data = df_prot,aes(x=question,y=Perc.)) + 
  ...
  ylab("% of Respondents") + xlab("Option") + ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black")) +
  ggtitle(paste0("Why do you feel that your household \n is protected from Coronavirus?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_hhrisk <- ggplot(df_hhrisk, aes(x=`At Risk`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black")) +
  ggtitle(paste0("Do you feel your household is at risk of Coronavirus?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_fol_gov <- ggplot(fol_gov, aes(x=`Follow Guide`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black")) +
  ggtitle(paste0("Out of 10 people in your village, \n how many do you think follow the gov’t guidelines?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_susp = ggplot(data = df_susp,aes(x=factor(question),y=Perc.)) + 
  ...
  theme(axis.text.x = element_text(colour="black",size=11), 
        ...
        plot.title = element_text(size = 10, face = "bold")) +
  ggtitle(paste0("If someone suspects they have coronavirus, \n what should they do?", " ", "(n=", n, ")"))+ theme_minimal()
p_susp 


```

```{r, eval=(my_subset$family[[1]]=="Preventive measures"),fig.height = 3, fig.width = 9, echo = FALSE, message = FALSE, warning = FALSE, results = 'hide'}
...
p_compl = ggplot(data = df_compl,aes(x=option,y=Perc.)) + 
  ...
  coord_flip() +
  geom_text(aes(label=Perc.),size=3, hjust = -0.2) +
  labs(y="% of Respondents",x="Option",title=paste0("Reported compliance with practices", " ", "(n=", n, ")")) + ylim(0,100)+
  theme(axis.text.x = element_text(colour="black"), axis.text.y = element_text(colour="black"))+ theme_minimal()
...
p_infosr <- ggplot(data = df_infosr,aes(x=question,y=Perc.)) + 
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"),
        plot.title = element_text(size = 10, face = "bold")) +
  ggtitle(paste0("How have you gotten your \n information on Coronavirus?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_mainsrc <- ggplot(df_maininfo, aes(x=`Main Source`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"),
        plot.title = element_text(size = 10, face = "bold")) +
  ggtitle(paste0("Which would you say is your \n main source of information?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_whomsr <- ggplot(data = df_whomsr,aes(x=question,y=Perc.)) + 
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"),
        plot.title = element_text(size = 10, face = "bold")) +
  ggtitle(paste0("From whom have you heard \n about Coronavirus?", " ", "(n=", n, ")"))+ theme_minimal()
...
p_whommain <- ggplot(df_whommain, aes(x=`Main Source`,y=perc)) +
  ...
  theme(axis.text.x = element_text(colour="black"), 
        axis.text.y = element_text(colour="black"),
        plot.title = element_text(size = 10, face = "bold")) +
  ggtitle(paste0("Whom would you say is your \n main source of information?", " ", "(n=", n, ")")) + theme_minimal()
