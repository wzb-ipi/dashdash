...
```{r, echo = FALSE, fig.cap="Average responses for a given day (dot) with 95% confidence intervals (whiskers)", fig.height = length(vars)*1.5, fig.height = (unique(my_data$id) %>% length)*1, message = FALSE, warning = FALSE}
