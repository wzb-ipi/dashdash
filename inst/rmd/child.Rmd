...
```{r, eval=(my_subset$family[[1]]=="Aid"), echo = FALSE, fig.height = 8, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}

all_bar_plot(my_data, my_subset, nrow=5)

```


```{r, eval=(my_subset$family[[1]]=="Daily behavior"), echo = FALSE, fig.height = 8, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Economic impact"), echo = FALSE, fig.height = 8, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Government performance"), echo = FALSE, fig.height = 8, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Trust"), echo = FALSE, fig.height = 8, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
