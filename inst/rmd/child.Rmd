...
```{r, eval=numeric$family[[1]]=="Schooling", echo = FALSE, fig.cap="3 day moving average with 95% confidence intervals", message = FALSE, warning = FALSE, fig.height = 3, fig.width = 6}
