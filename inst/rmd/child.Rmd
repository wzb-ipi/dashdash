...
```{r, eval=(my_subset$family[[1]]=="Elections_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r, eval=(my_subset$family[[1]]=="Vaccine acceptability_"), echo = FALSE, fig.height = nrow(my_subset)*1.42 + 1, fig.width=11, message = FALSE, warning = FALSE, results = 'hide'}

dashdash:::bars_together(my_data, my_subset, nrow=4)
