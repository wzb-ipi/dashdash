...
```{r, eval=(my_subset$family[[1]]=="Health-seeking"), echo = FALSE, fig.height = 8, message = FALSE, warning = FALSE, results = 'hide'}

df <- my_data

my_subset <- filter(my_subset, variable=="hlth4")
...
# select all vars from my_subset
...
```{r, eval=(my_subset$family[[1]]=="Beliefs about Covid"), echo = FALSE, fig.height = 8, message = FALSE, warning = FALSE, results = 'hide'}

df <- my_data

my_subset <- filter(my_subset, variable=="cov7")
...
```{r, eval=(my_subset$family[[1]]=="Economic situation"), echo = FALSE, fig.height = 8, fig.width = 6, echo = FALSE, message = FALSE, warning = FALSE, results = 'hide'}

dashdash:::all_bar_plot(my_data, my_subset, nrow = 2)

```

```{r, eval=(my_subset$family[[1]]=="Food security"), echo = FALSE, fig.height = 8, fig.width = 6, echo = FALSE, message = FALSE, warning = FALSE, results = 'hide'}
